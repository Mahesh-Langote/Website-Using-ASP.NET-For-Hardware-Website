<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="without_login_contact" %>
...
<body>
    ...
    <div class="holder">
        ...
        <p>
        <h2 style="margin:0 0 0 400px ;"> Contact Us
</h2>
        
<strong>Call Us</strong> <br />

For product, order related queries and pretty much anything else, get in touch with us at 080-46666777 
<p style="margin:20px 0 10px 0;">
<strong>Email</strong>
<br />
For product, order related queries and pretty much anything else, write to hello@urbanladder.com
...
<br />
If you are a property manager, an architect, builder, designer or any business enterprise looking to buy in bulk for your hotel, office or any other property, we'd love to help! Email us at bulk@urbanladder.com
</p>

<p style="margin:20px 0 10px 0;">
<strong>Partnerships</strong>
<br />
If you’re an interior designer or an architect, the Design Network is for you. Partner with us, and discover an easier way to set up gorgeous homes.<br />
